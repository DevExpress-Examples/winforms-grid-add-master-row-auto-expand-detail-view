...
'			Me.gridView1.InitNewRow += New DevExpress.XtraGrid.Views.Grid.InitNewRowEventHandler(Me.OnGridViewInitNewRow);
'			Me.gridView1.RowCountChanged += New System.EventHandler(Me.OnGridViewRowCountChanged);
			' 
			' nwindDataSet
			' 
